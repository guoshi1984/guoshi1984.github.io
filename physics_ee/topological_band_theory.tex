...
\end{align*}
Since we get the wavefunction and eigenenergy, there are two ways to find out the current.\\
1) One way is to use the semiclassical approach. We can calculate group velocity given a wavevector k
\begin{align*}
...
\begin{align*}
	v = \dot{q} = \frac{\partial H}{\partial p}
\end{align*}
...
\end{align*}
Where the second term is the Berry phase.
