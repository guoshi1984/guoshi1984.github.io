...
\noindent{\bf b. Expectation and Variance}\\
$E(X_j) =0$, $Var(X_j) =1$,\\
$Var(M_k - M_l) = \sum_{i=l}^{k} Var(X_i) = k - l$;\\

\noindent{\bf c. Martingale Property} \\
$E(M_l| F_k)$\\
$=E((M_l - M_k + M_k) | F_k)$\\
...
\noindent{ \bf a. Scaled Symmetric Random Walk Definition}\\
...
\noindent { \bf a. Limit of Scaled Symmetric Random Walk: Brownian Motion} \\
...
\noindent { \bf b.	Quadratic variation of Brownian motion } \\
...
\noindent{ \bf c. From Scaled Asymmetric Random Walk to Geometric Brownian motion}\\
