...
\noindent [{\bf External Project}] Implemented and coded option pricing algorithms(analytical and Monte Carlo) based various different models(Black-Scholes, Heston, Stochastic jump diffusion).\\
