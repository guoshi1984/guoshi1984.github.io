...
\end{align*} 
{\bf Properties of Fixed effect estimator}\\
1) Unbiasdness\\
\begin{align*}
...
{\bf Estimation of $\sigma^2_{u}$ and $\sigma^2_{\alpha}$}\\
...
\end{align*}
{\bf Coping with the Limitation of Random Model}\\
...
{\bf Fixed Effect Model Generalization}\\
